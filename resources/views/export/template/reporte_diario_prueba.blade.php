...
<html>
    ...
    <table>
        ...
        <tr>
            ...
            <td class="celd" style="font-size: 24pt;background-color:#A9D08E;">AVANCE(%)</td>
            <td style="border: none"></td>
            <td class="celd" colspan="2"style="font-size: 24pt;background-color:#A9D08E;">PIM</td>
        </tr>
        @foreach($resumen_pliego as $key => $row )
            <tr>
                ...
                <td class="celd" style="font-size: 24pt;">{{ number_format($row->pim,2) }}</td>
                <td class="celd" style="font-size: 24pt;">{{ number_format($row->dev_dia,2) }}</td>
                <td class="celd" style="font-size: 24pt;">{{ number_format($row->pim - $row->dev_dia,2) }}</td>
                <td class="celd" style="font-size: 24pt;">{{ number_format($row->avance,2) }}</td>
                <td style="border: none"></td>
                @if($key == 0)
                    <td class="celd" colspan="2" style="font-size: 28pt;">{{ number_format($resumen_pliego_total->pim,2) }}</td>
                @elseif($key == 1)
                    <td style="border: none"></td>
                @elseif($key == 2)
                    <td class="celd" colspan="2"style="font-size: 24pt;background-color:#A9D08E;">DEVENGADO ACTUAL</td>
                @elseif($key == 3)
                    <td class="celd" colspan="2" style="font-size: 28pt;">{{ number_format($resumen_pliego_total->dev_dia,2) }}</td>
                @elseif($key == 4)
                    <td style="border: none"></td>
                @elseif($key == 5)
                    <td class="celd" colspan="2"style="font-size: 24pt;background-color:#A9D08E;">AVANCE(%)</td>
                @elseif($key == 6)
                    <td class="celd" colspan="2" style="font-size: 28pt;">{{ number_format($resumen_pliego_total->avance,2) }}</td>
                @else
                    <td style="border: none"></td>
                @endif
            </tr>
        ...
        <tr>
            ...
            <td class="celd" style="font-size: 26pt;background-color:#A9D08E;">{{ number_format($resumen_pliego_total->pim,2) }}</td>
            <td class="celd" style="font-size: 26pt;background-color:#A9D08E;">{{ number_format($resumen_pliego_total->dev_dia,2) }}</td>
            <td class="celd" style="font-size: 26pt;background-color:#A9D08E;">{{ number_format($resumen_pliego_total->pim - $resumen_pliego_total->dev_dia,2) }}</td>
            <td class="celd" style="font-size: 26pt;background-color:#A9D08E;">{{ number_format($resumen_pliego_total->avance,2) }}</td>
            <td style="border: none"></td>
            <td class="celd" colspan="2"style="font-size: 24pt;background-color:#A9D08E;">PENDIENTE DEVENGADO A 31 DICIEMBRE</td>
        </tr>
        <tr>
            <td style="border: none"></td>
            <td style="border: none"></td>
            ...
            <td style="border: none"></td>
            <td style="border: none"></td>
            <td class="celd" colspan="2" style="font-size: 28pt;">{{ number_format($resumen_pliego_total->pim - $resumen_pliego_total->dev_dia,2) }}</td>
        </tr>
        <tr>
            <td colspan="15" style="border: none"></td>
        </tr>
        ...
        <tr>
            ...
            <td style="border: none"></td>
            <td style="border: none"></td>
            <td class="celd" colspan="2"style="font-size: 24pt;background-color:#A9D08E;">PROGRAMACION {{ $mes_nombre}} - MEF</td>
        </tr>
        @foreach($data_metas as $key => $row )
            @php
                $meta_mes_2 = 0;
            ...
            <tr>
                ...
                <td class="celd" style="font-size: 24pt;">{{ number_format($meta_mes_2,2) }}</td>
                <td class="celd" style="font-size: 24pt;">{{ number_format($dev_mes_2,2) }}</td>
                <td class="celd" style="font-size: 24pt;">{{ number_format($meta_mes_2 - $dev_mes_2,2) }}</td>
                <!-- <td class="celd" style="font-size: 24pt;">{{ number_format($pen_dev_acu_2,2) }}</td> -->
                @if($meta_mes_2 == 0)
                ...
                <td style="border: none"></td>
                @if($key == 0)
                    <td class="celd" colspan="2" style="font-size: 28pt;">{{ number_format($t_1_meta_mes,2) }}</td>
                @elseif($key == 1)
                    <td style="border: none"></td>
                @elseif($key == 2)
                    <td class="celd" colspan="2"style="font-size: 24pt;background-color:#A9D08E;">EJECUCION {{ $mes_nombre}}</td>
                @elseif($key == 3)
                    <td class="celd" colspan="2" style="font-size: 28pt;">{{ number_format($t_1_devengado_mes,2) }}</td>
                @elseif($key == 4)
                    <td style="border: none"></td>
                @elseif($key == 5)
                    <td class="celd" colspan="2"style="font-size: 24pt;background-color:#A9D08E;">AVANCE(%)</td>
                @elseif($key == 6)
                    @if($t_1_meta_mes != 0 )
                        <td class="celd" colspan="2" style="font-size: 28pt;">{{ number_format($t_1_devengado_mes*100/$t_1_meta_mes,2) }}</td>
                    @else
                        <td class="celd" colspan="2" style="font-size: 28pt;">0</td>
                    @endif
                @else
                    <td style="border: none"></td>
                @endif
        ...
        <tr>
            ...
            <td class="celd" style="font-size: 26pt;background-color:#A9D08E;">{{ number_format($t_1_meta_mes,2) }}</td>
            <td class="celd" style="font-size: 26pt;background-color:#A9D08E;">{{ number_format($t_1_devengado_mes,2) }}</td>
            <td class="celd" style="font-size: 26pt;background-color:#A9D08E;">{{ number_format($t_1_meta_mes - $t_1_devengado_mes,2) }}</td>
            <!-- <td class="celd" style="font-size: 26pt;background-color:#A9D08E;">{{ number_format($total_pen_dev_acu_2,2) }}</td> -->
            @if($t_1_meta_mes != 0 )
            ...
            <td style="border: none"></td>
            <td style="border: none"></td>
            <td class="celd" colspan="2"style="font-size: 24pt;background-color:#A9D08E;">PENDIENTE DEVENGADO {{ $mes_nombre}} - MEF</td>
        </tr>
        <tr>
            <td style="border: none"></td>
            <td style="border: none"></td>
            ...
            <td style="border: none"></td>
            <td style="border: none"></td>
            <td class="celd" colspan="2" style="font-size: 28pt;">{{ number_format($t_1_meta_mes - $t_1_devengado_mes,2) }}</td>
        </tr>
        <tr>
