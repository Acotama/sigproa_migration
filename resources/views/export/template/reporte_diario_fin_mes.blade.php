...
<table>
    ...
    @php
        ...
        foreach ($data_metas as $key => $row) {
            if ($mes == 1) {
                ...
                $t_1_meta_mes += $row->m_septiembre;
                $t_1_cantidad += $row->cant_septiembre;
    ...
    <tr>
        <td rowspan="2" colspan="2" style="border: none;text-align:center"><img
                src="{{ asset('logo_opmi.png') }}"></td>
        <td colspan="2" class="celd" style="font-size: 26pt;background-color:#A9D08E;">ACTUALIZADO AL</td>
        <td rowspan="2" style="border: none;"></td>
        <td rowspan="2" style="border: none;"></td>
        <td rowspan="2" colspan="9" class="celd" style="border: none;font-size: 72pt;text-align:left">
            SEGUIMIENTO DE INVERSIONES {{ $year }}</td>
    </tr>
    <tr>
    ...
    @foreach ($resumen_pliego as $key => $row)
        <tr>
            ...
            @elseif($key == 3)
                <td class="celd" style="font-size: 28pt;">{{ number_format($resumen_pliego_total->dev_dia, 0) }}
                </td>
            @elseif($key == 4)
                <td style="border: none"></td>
            @elseif($key == 5)
                <td class="celd" style="font-size: 24pt;background-color:#A9D08E;">DEVENGADO AVANCE(%)</td>
            @elseif($key == 6)
                <td class="celd" style="font-size: 28pt;">{{ number_format($resumen_pliego_total->avance, 2) }}
                </td>
            @else
                <td style="border: none"></td>
            @endif
    ...
    <tr>
        ...
        <td class="celd" style="font-size: 26pt;background-color:#A9D08E;">
            {{ number_format($resumen_pliego_total->pim, 0) }}</td>
        <td class="celd" style="font-size: 26pt;background-color:#A9D08E;">
            {{ number_format($resumen_pliego_total->dev_dia, 0) }}</td>
        <td class="celd" style="font-size: 26pt;background-color:#A9D08E;">
            {{ number_format($resumen_pliego_total->pim - $resumen_pliego_total->dev_dia, 0) }}</td>
        <td class="celd" style="font-size: 26pt;background-color:#A9D08E;">
            {{ number_format($resumen_pliego_total->avance, 2) }}</td>
        <td class="celd" style="font-size: 26pt;background-color:#A9D08E;">
            {{ number_format($resumen_pliego_total->certificado, 0) }}</td>
        <td class="celd" style="font-size: 26pt;background-color:#A9D08E;">
            {{ number_format($resumen_pliego_total->avance_certificado, 0) }}</td>
        <td style="border: none"></td>
    ...
    <tr>
        ...
        <td style="border: none"></td>
        <td style="border: none"></td>
        <td class="celd" style="font-size: 28pt;">
            {{ number_format($resumen_pliego_total->pim - $resumen_pliego_total->dev_dia, 2) }}</td>
    </tr>
    <tr>
        <td colspan="15" style="border: none"></td>
    </tr>
    <tr>
        <td colspan="15" class="celd" style="font-size: 48pt;background-color:#A9D08E;">RESUMEN DE EJECUCION POR
            UNIDAD EJECUTORA AL MES DE {{ $mes_nombre }} - MEF</td>
    </tr>
    <tr>
        <td colspan="15" style="border: none"></td>
    </tr>
    ...
    <tr>
        ...
        <td style="border: none"></td>
        <td style="border: none"></td>
        <td class="celd" style="font-size: 24pt;background-color:#A9D08E;">PROGRAMACION {{ $mes_nombre }} - MEF
        </td>
    </tr>
    @foreach ($data_metas as $key => $row)
        @php
            ...
            if ($mes == 1) {
                ...
                $pen_dev_acu_2 =
                    $row->pen_enero + $row->pen_febrero + $row->pen_marzo + $row->pen_abril + $row->pen_mayo;
            } elseif ($mes == 7) {
                ...
                $meta_mes_2 = $row->m_septiembre;
                $cantidad = $row->cant_septiembre;
        ...
        <tr>
            ...
            @elseif($key == 6)
                @if ($t_1_meta_mes != 0)
                    <td class="celd" style="font-size: 28pt;">
                        {{ number_format(($t_1_devengado_mes * 100) / $t_1_meta_mes, 2) }}</td>
                @else
    ...
    <tr>
        ...
        <td class="celd" style="font-size: 26pt;background-color:#A9D08E;">{{ number_format($t_1_meta_mes, 0) }}
        </td>
        <td class="celd" style="font-size: 26pt;background-color:#A9D08E;">
            {{ number_format($t_1_devengado_mes, 0) }}</td>
        <td class="celd" style="font-size: 26pt;background-color:#A9D08E;">
            {{ number_format($t_1_meta_mes - $t_1_devengado_mes, 0) }}</td>
        ...
        @endif
        <td class="celd" style="font-size: 26pt;background-color:#A9D08E;">
            {{ number_format($t_1_certificado_mes, 0) }}</td>
        <td style="border: none"></td>
        <td style="border: none"></td>
        <td style="border: none"></td>
        <td class="celd" style="font-size: 24pt;background-color:#A9D08E;">PENDIENTE DEVENGADO {{ $mes_nombre }}
            - MEF</td>
    </tr>
    <tr>
        <td style="border: none"></td>
    ...
    <tr>
        <td colspan="15" class="celd" style="font-size: 48pt;background-color:#A9D08E;">HISTORIAL DE DEVENGADOS
        </td>
    </tr>
    <tr>
        <td colspan="13" style="border: none"></td>
    ...
    @if ($mes > 6)
        ...
        <tr>
            ...
            <td style="border: none;"></td>
            <td class="celd" style="font-size: 22pt;">PROGRAMACION</td>
            <td class="celd" style="font-size: 24pt;">{{ number_format($historial_mensual_meta->m_setiembre, 0) }}
            </td>
        </tr>
        <tr>
            <td colspan="13" style="border: none"></td>
        ...
        <tr>
            ...
            <td style="border: none;"></td>
            <td class="celd" style="font-size: 22pt;">PROGRAMACION</td>
            <td class="celd" style="font-size: 24pt;">{{ number_format($historial_mensual_meta->m_octubre, 0) }}
            </td>
            <td style="border: none;"></td>
            <td class="celd" style="font-size: 22pt;">PROGRAMACION</td>
            <td class="celd" style="font-size: 24pt;">{{ number_format($historial_mensual_meta->m_noviembre, 0) }}
            </td>
            <td style="border: none;"></td>
            <td class="celd" style="font-size: 22pt;">PROGRAMACION</td>
            <td class="celd" style="font-size: 24pt;">{{ number_format($historial_mensual_meta->m_diciembre, 0) }}
            </td>
        </tr>
        <tr>
            <td colspan="13" style="border: none"></td>
    ...
    @endif
    <tr>
        <td colspan="15" class="celd" style="font-size: 48pt;background-color:#A9D08E;">PROGRAMACION MEF vs
            FORMATO 12-B</td>
    </tr>
    <tr>
        <td colspan="13" style="border: none"></td>
    ...
    <tr>
        <td colspan="15" class="celd" style="font-size: 48pt;background-color:#A9D08E;">RESUMEN DE EJECUCION POR
            PROYECTO AL MES DE {{ $mes_nombre }}</td>
    </tr>
    <tr>
        <td colspan="13" style="border: none"></td>
    </tr>
    ...
    <tr>
        ...
        <td class="celd" rowspan="2" colspan="3" style="font-size: 20pt;background-color:#D3EBF7;">PROYECTO
        </td>
        ...
        <td class="celd" colspan="6" style="font-size: 20pt;background-color:#D3EBF7;">DEVENGADO AL
            {{ $fecha->fecha }}</td>
    </tr>
    <tr>
    ...
    @foreach ($uei as $item)
        ...
        @if (count($data_hoy_a) > 0)
            ...
            <tr>
                ...
                <td colspan="4" class="celd" style="font-size: 16pt;background-color:#9BC2E6;">
                    {{ $item }}</td>
                <td class="celd" style="font-size: 18pt;background-color:#9BC2E6;">
                    {{ number_format($programacion_t, 2) }}</td>
                <td class="celd" style="font-size: 18pt;background-color:#9BC2E6;">
                    {{ number_format($ejecucion_t, 2) }}</td>
                @if ($programacion_t > 0)
                    <td class="celd" style="font-size: 18pt;background-color:#9BC2E6;">
                        {{ number_format(($ejecucion_t * 100) / $programacion_t, 2) }}</td>
                @else
                ...
                <td class="celd" style="font-size: 18pt;background-color:#9BC2E6;">{{ number_format($lunes_t, 2) }}
                </td>
                <td class="celd" style="font-size: 18pt;background-color:#9BC2E6;">{{ number_format($martes_t, 2) }}
                </td>
                <td class="celd" style="font-size: 18pt;background-color:#9BC2E6;">
                    {{ number_format($miercoles_t, 2) }}</td>
                <td class="celd" style="font-size: 18pt;background-color:#9BC2E6;">{{ number_format($jueves_t, 2) }}
                </td>
                <td class="celd" style="font-size: 18pt;background-color:#9BC2E6;">
                    {{ number_format($viernes_t, 2) }}</td>
                <td class="celd" style="font-size: 18pt;background-color:#9BC2E6;">
                    {{ number_format($total_semana_t, 2) }}</td>
            </tr>
            @foreach ($data_hoy_meta as $key => $row)
                ...
                <tr>
                    ...
                    <td class="celd_num" colspan="3" style="text-align:left;font-size: 12pt;">
                        {{ $row->nom_proyec }}</td>
                    ...
                    @if ($meta_mes > 0)
                        <td class="celd_num" style="font-size: 18pt;">
                            {{ number_format(($row->dev_mes * 100) / $meta_mes, 2) }}</td>
                    @else
...
@endif -->
                    @if (count($lunes) > 0)
                        <td class="celd_num" style="font-size: 18pt;">{{ number_format($lunes->dif_dev_dia, 2) }}
                        </td>
                        @php
                    ...
                    @endif
                    @if (count($martes) > 0)
                        <td class="celd_num" style="font-size: 18pt;">{{ number_format($martes->dif_dev_dia, 2) }}
                        </td>
                        @php
                    ...
                    @if (count($miercoles) > 0)
                        <td class="celd_num" style="font-size: 18pt;">{{ number_format($miercoles->dif_dev_dia, 2) }}
                        </td>
                        @php
                    ...
                    @endif
                    @if (count($jueves) > 0)
                        <td class="celd_num" style="font-size: 18pt;">{{ number_format($jueves->dif_dev_dia, 2) }}
                        </td>
                        @php
                    ...
                    @endif
                    @if (count($viernes) > 0)
                        <td class="celd_num" style="font-size: 18pt;">{{ number_format($viernes->dif_dev_dia, 2) }}
                        </td>
                        @php
        ...
        @if (count($data_hoy_adicional) > 0)
            <tr>
                <td class="celd" colspan='14' style="font-size: 18pt;background-color:#9BC2E6;">DEVENGADOS NO
                    PROGRAMADOS</td>
            </tr>
...
@endif -->
    ...
    <tr>
        ...
        <td class="celd" style="font-size: 20pt;background-color:#A9D08E;">{{ number_format($t_programacion, 2) }}
        </td>
        <td class="celd" style="font-size: 20pt;background-color:#A9D08E;">{{ number_format($t_ejecucion, 2) }}
        </td>
        @if ($t_programacion > 0)
            <td class="celd" style="font-size: 20pt;background-color:#A9D08E;">
                {{ number_format(($t_ejecucion * 100) / $t_programacion, 2) }}</td>
        @else
        ...
        <td class="celd" style="font-size: 20pt;background-color:#A9D08E;">{{ number_format($t_miercoles, 2) }}
        </td>
        ...
        <td class="celd" style="font-size: 20pt;background-color:#A9D08E;">{{ number_format($t_semana_total, 2) }}
        </td>
    </tr>
</table>
