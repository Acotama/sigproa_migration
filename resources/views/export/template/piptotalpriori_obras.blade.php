...
<table>
      ...
      <tr>
        ...
        <td class="header" rowspan="2" width="120">PROVINCIA</td>
        ...
        <td class="header" colspan="12">ESTADO DE OBRAS</td>
      ...
      <tr id="header">
        ...
        <td class="header" width="120">AÑOS DE EJECUCIÓN</td>
        <td class="header" width="100">ESTADO</td>
        <td class="header" width="500">DESCRIPCIÓN</td>
        <td class="header" width="80">AV. FÍSICO</td>
        <td class="header" width="80">F.INICIO PROGRAMADA</td>
        <td class="header" width="80">F.FIN PROGRAMADA</td>
        <td class="header" width="80">F.INICIO REAL</td>
        <td class="header" width="80">F.FIN REAL</td>
        <td class="header" width="80">F.INAUGURACIÓN </td>
        <td class="header" width="80">ESTADO ACTUALIZADO AL</td>
      ...
      <tr id="Rows">
          ...
          <td style="border-top: 1pt solid #000;" class="center" rowspan="<?php echo $rowspanNum ?>">{{ $row->nom_prov }}</td>
          ...
          <td style="border-top: 1pt solid #000;" class="center"> - </td>
          <td style="border-top: 1pt solid #000;" class="center"> - </td>
          <td style="border-top: 1pt solid #000;" class="center">{{ $row->etapa_main }}</td>
          ...
          ?>
          <td style="border-top: 1pt solid #000;" class="center"><?php echo trim($row->obras[$rowspanNum-1]->nom_meta) == '' ? 'OBRA' : strtoupper($row->obras[$rowspanNum-1]->nom_meta); ?></td>
          ...
          <td style="border-top: 1pt solid #000;" class="center"> {{ $row->obras[$rowspanNum-1]->etapa_main }} </td>
          ...
          @else
          <td rowspan="<?php echo $rowspanNum ?>" style="border-top: 1pt solid #000;background-color:red;color:white;" class="center"> PENDIENTE </td>
          @endif
      ...
      <tr id="Row5" class="body-row-2">
          ...
          <td class="center"><?php echo trim($row->obras[$rowspanNum-1]->nom_meta) == '' ? 'OBRA' : strtoupper($row->obras[$x-1]->nom_meta); ?></td>
          <td class="center">{{ $row->obras[$x-1]->mod_ejec }}</td>
          <td class="center">{{ $row->obras[$x-1]->anio_ejec }}</td>
          <td class="center">{{ $row->obras[$x-1]->etapa_main }}</td>
