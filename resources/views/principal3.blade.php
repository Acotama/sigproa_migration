...
@section('body')
    ...
    <div id="print">
        <div class="well text-center">
            <span
                style="font-weight: bold;font-size: 22px;font-family: 'Source Sans Pro', 'Helvetica Neue', Helvetica, Arial, sans-serif;">GOBIERNO
                REGIONAL DE LIMA</span>
        </div>
        {{-- <a href="javascript:void(0);" id="printButton">Print</a>  --}}
        {{-- CUADROS INFORMACIONn --}}
        <div class="row">
            {{-- <form action="{{ url('/meta_mef/insert') }}" method="POST">
            @csrf
            ...
            <div style="text-align: center">
                <div class="btn-group" data-toggle="btn-toggle">
                    ...
                    <a href="#" id="historia_2025" onclick="historia('2025')" style="font-weight: bold"
                        class="his_anio btn btn-primary btn-sm  active">2025</a>
                </div>
            </div>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number" style="font-size: 2em;text-align: center"
                                id="n_proyectos">0</span>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-xs-12">
                        ...
                        <li class="pull-right header">
                            <div class="row">
                                <div class="col-md-3 no-print">
                                    ...
                                    <button id="btnDescargarTabla" class="btn btn-primary"><i class="fa fa-print"></i></button>
                                </div>
                                <div class="col-md-9">
                                ...
                                <table class="table table-bordered" style="width:100%;margin: 0px;"
                                    ...
                                    <thead style="background-color: rgb(136 185 214);">
                                        <tr>
                                            ...
                                            <th class="text-center subtotal_dev"
                                                style="width:130px;vertical-align:middle;" rowspan="2">DEV ENE<label
                                                    class="mesabr"></th>
    ...
    <script type="text/javascript">
        ...
        document.getElementById("btnDescargarTabla").addEventListener("click", function () {
            const elemento = document.getElementById("tb_pry_ejecutados_table");
            ...
            html2canvas(elemento, {
                ...
                enlace.download = "reporte-ejecucion.png";
