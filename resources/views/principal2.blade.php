...
<div id="print">
    <div class="well text-center">
        <span style="font-weight: bold;font-size: 22px;font-family: 'Source Sans Pro', 'Helvetica Neue', Helvetica, Arial, sans-serif;">GOBIERNO REGIONAL DE LIMA</span>
    </div>
    ...
    <div class="row">
        <div style="text-align: center">
            <div class="btn-group" data-toggle="btn-toggle">
                ...
                <a href="#" id="historia_2021" onclick="historia('2021')" style="font-weight: bold" class="his_anio btn btn-success btn-sm  active">2021</a>
            </div>
        </div>
                                ...
                                <thead style="background-color: rgba(146, 208, 80, 1)">
                                    <tr>
                                        ...
                                        @if(Auth::user()->can('pir-proyectos-devengadoreal'))
                                            <th class="text-center text-uppercase seleccion hide" style="width:130px;vertical-align:middle;" rowspan="2">DEVENGADO <label class="mes"></label> SIAF</th>
                                        @endif
                    ...
                    success: function(response) {
                        ...
                        $.each(response.data, function(key, value) {
                            ...
                            @if (Auth::user()->can('pir-proyectos-devengadoreal'))
                                //DEVENGADO REAL
                                if($dif_real > 0){
                                html += "<td class='text-center seleccion hide' style='vertical-align:middle;'><span style='color:green;font-weight:bold;'>+ " + number_format($dif_real,0) + "</span><br>" +
                                    number_format(value['mes_actual'],0) + "</td>";
                                }else if($dif_real < 0 ){ html
                                    +="<td class='text-center seleccion hide' style='vertical-align:middle;'><span style='color:red;font-weight:bold;'>- "
                                    + number_format(Math.abs($dif_real),0) + "</span><br>" + number_format(value['mes_actual'],0) + "</td>" ; }else{
                                    html +="<td class='text-center seleccion hide' style='vertical-align:middle;'>" +
                                    number_format(value['mes_actual']==null ? 0 : value['mes_actual'],0) + "</td>" ; } @endif

                            //DEVENGADO
                            if (parseFloat(value['dif_dev_dia']) > 0) {
                                html +=
                            ...
                            } else if (parseFloat(value['dif_dev_dia']) < 0) {
                                html +=
                        ...
                        @if (Auth::user()->can('pir-proyectos-devengadoreal'))
                            //TOTAL DEVENGADO REAL
                            if( $t_total_dif_real > 0 ){
                            html_pie += "<td class='text-center seleccion hide' style='vertical-align:middle;'><span style='color:green;font-weight:bold;'>+ " + number_format( $t_total_dif_real,0) + "</span><br>" +
                                number_format($t_total_dev_real,0) + "</td>";
                            }else if( $t_total_dif_real < 0 ){ html_pie
                                +="<td class='text-center seleccion hide' style='vertical-align:middle;'><span style='color:red;font-weight:bold;'>- "
                                + number_format(Math.abs($t_total_dif_real),0) + "</span><br>" + number_format($t_total_dev_real,0) + "</td>" ;
                                }else{ html_pie +="<td class='text-center seleccion hide' style='vertical-align:middle;'>" +
                                number_format($t_total_dev_real,0) + "</td>" ; } @endif
                        //TOTAL DEVENGADO
                        if ($t_total_dif > 0) {
                            html_pie +=
                                "<td class='text-center seleccion' style='vertical-align:middle;'><span style='color:green;font-weight:bold;'>+ " +
