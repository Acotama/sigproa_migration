...
@section('htmlhead')
    ...
    <style>
        ...
        .table-indications ul {
            padding-left: 20px;
            list-style-type: disc;
        }

        .table-indications strong {
            color: #333;
        }

        .table-indications span#fecha-actualizacion {
            font-weight: bold;
            color: #0056b3;
        }
...
@section('body')
    ...
    <div class="well text-center"
        style="padding: 15px; background-color: #f8f9fa; border: 1px solid #ddd; border-radius: 8px;">
        <div
            style="font-weight: bold; font-size: 24px; font-family: 'Source Sans Pro', 'Helvetica Neue', Helvetica, Arial, sans-serif; color: #2c3e50;">
            GOBIERNO REGIONAL DE LIMA
        </div>
        @if ($esuei === 1)
            <div
                style="font-weight: 600;font-size: 16px; font-family: 'Source Sans Pro', 'Helvetica Neue', Helvetica, Arial, sans-serif; color: #34495e; margin-top: 5px;">
                UNIDAD EJECUTORA: {{ $uei }}
            </div>
        @endif
    </div>

    {{-- CUADROS INFORMACIONn --}}
    <div class="row">
        <div style="text-align: center">
            <div class="btn-group" data-toggle="btn-toggle">
                <a href="#" id="historia_2015" onclick="historia('2015')"
                    class="his_anio btn btn-default btn-sm">2015</a>
                <a href="#" id="historia_2016" onclick="historia('2016')"
                    class="his_anio btn btn-default btn-sm">2016</a>
                <a href="#" id="historia_2017" onclick="historia('2017')"
                    class="his_anio btn btn-default btn-sm">2017</a>
                <a href="#" id="historia_2018" onclick="historia('2018')"
                    class="his_anio btn btn-default btn-sm">2018</a>
                <a href="#" id="historia_2019" onclick="historia('2019')"
                    class="his_anio btn btn-default btn-sm">2019</a>
                <a href="#" id="historia_2020" onclick="historia('2020')"
                    class="his_anio btn btn-default btn-sm">2020</a>
                <a href="#" id="historia_2021" onclick="historia('2021')"
                    class="his_anio btn btn-default btn-sm">2021</a>
                <a href="#" id="historia_2022" onclick="historia('2022')"
                    class="his_anio btn btn-default btn-sm">2022</a>
                <a href="#" id="historia_2023" onclick="historia('2023')"
                    class="his_anio btn btn-default btn-sm">2023</a>
                <a href="#" id="historia_2024" onclick="historia('2024')"
                    class="his_anio btn btn-default btn-sm">2024</a>
                <a href="#" id="historia_2025" onclick="historia('2025')"
                    class="his_anio btn btn-default btn-sm">2025</a>
                <a href="#" id="historia_2026" onclick="historia('2026')" style="font-weight: bold"
                    class="his_anio btn btn-primary btn-sm  active">2026</a>
            </div>
        </div>
        <div style="margin-top: 10px">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text" id="text_pia" style="font-weight: bold;">PIA
                            {{ date('Y') }}</span>
                        <span class="info-box-number" style="font-size: 1.73em;text-align: center" id="pia">0</span>
                        <span class="info-box-number" style="font-size: 1.3em;text-align: center" id="avance_pia">( 0.0%
                            )</span>
                    </div>
                </div>
            </div>
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text" id="text_pim" style="font-weight: bold;">PIM
                            {{ date('Y') }}</span>
                        <span class="info-box-number" style="font-size: 1.73em;text-align: center"
                            id="pim">0</span>
                        <span class="info-box-number" style="font-size: 1.3em;text-align: center" id="avance">(
                            0.0% )</span>
                    </div>
                </div>
            </div>
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text" id="text_dev" style="font-weight: bold;">DEVENGADO
                            {{ date('Y') }}</span>
    ...
    {{-- <button id="run-btn" class="btn btn-success">Ejecutar Python</button> --}}
            ...
            <section class="col-lg-3 connectedSortable ui-sortable">
                <div class="nav-tabs-custom" style="cursor: default;">
                    ...
                    <ul class="nav nav-tabs pull-right ui-sortable-handle">
                        <li class="pull-left header"><i class="fa fa-line-chart"></i>RANKING {{ date('Y') }}</li>
                    </ul>
            ...
            <div class="nav-tabs-custom" style="cursor: default;">
                <ul class="nav nav-tabs pull-right ui-sortable-handle">
                    <li class="pull-left header">
                        <i class="fa fa-line-chart"></i>AVANCE DE LA EJECUCION DE LOS PROYECTOS DE INVERSION
                        {{ date('Y') }}
                    </li>
                    <li class="pull-right header">
                        <div class="row">
                            <div class="col-md-3 no-print">
                                ...
                                <button id="btnDescargarTabla" class="btn btn-primary"><i
                ...
                <div class="tab-content">
                    <div class="chart tab-pane active" style="position: relative;">
                        <div class="table  table-responsive tb_pry_ejecutados" id="tb_pry_ejecutados_table">
                            <table class="table table-bordered" style="width:100%;margin: 0px;" id="tb_pry_ejecutados">
                                <thead style="background-color: rgb(136 185 214);">
                                    <tr>
                                        <th class="text-center" style="width:60px;vertical-align:middle;" rowspan="2">
                                            N° PRY</th>
                                        <th class="text-center" style="width:200px;vertical-align:middle;"
                                            rowspan="2">UEI</th>
                                        <th class="text-center" style="width:80px;vertical-align:middle;" rowspan="2">
                                            PIM {{ date('Y') }}</th>
                                        <th class="text-center" style="width:400px;vertical-align:middle;"
                                        ...
                                        @if (Auth::user()->can('pir-proyectos-devengadoreal'))
                                            <th class="text-center text-uppercase seleccion hide"
                                                style="width:130px;vertical-align:middle;" rowspan="2">DEVENGADO
                                                <label class="mes"></label> SIAF
                                            </th>
                                        @endif
                                        ...
                                        <th colspan="2" class="text-center"
                                            style="width:130px;vertical-align:middle;">META <label class="mes"></label>
                                            POR MEF</th>
                                    </tr>
                                    <tr>
                                        <th class="text-center" style="width:100px;vertical-align:middle;">CERTIFICADO
                                            {{ date('Y') }}</th>
                                        <th class="text-center" style="width:100px;vertical-align:middle;">COMPROMISO
                                            MENSUAL {{ date('Y') }}</th>
                                        <th class="text-center" style="width:100px;vertical-align:middle;">DEVENGADO
                                            {{ date('Y') }}</th>
                                        ...
                                        <th class="text-center" style="width:130px;vertical-align:middle;">INDICADOR
                                        </th>
                                        <th class="text-center seleccion_apru" id="mes_9_apru"
                                            style="width:130px;vertical-align:middle;">S/ META</th>
                                    </tr>
                                </thead>
                        ...
                        <div class="table-indications">
                            <ul>
                                <li><strong>Columna N° Pry:</strong> Representa los <em>Proyectos de Inversión
                                        Pública</em> con un <em>Presupuesto Institucional Modificado (PIM)</em>
                                    asignado.</li>
                                <li><strong>Columna UEI:</strong> Al hacer clic en un nombre de UEI, se abrirá un modal
                                    con:
                                    <ul>
                                        <li>Los <em>proyectos con metas programadas</em>.</li>
                                        <li>Los <em>proyectos que ya se han ejecutado</em>.</li>
                                    </ul>
                                </li>
                                <li><strong>Columna Devengado Mensual:</strong>
                                    <ul>
                                        <li>El símbolo <strong>“+”</strong> indica un <em>aumento en el devengado
                                                mensual</em>.</li>
                                        <li>El símbolo <strong>“-”</strong> indica una <em>disminución en el devengado
                                                mensual</em>.</li>
                                    </ul>
                                </li>
                                <li><strong>Fecha de Actualización:</strong> La tabla está actualizada al <span
                                        id="fechadevengado" style="font-size: 13px;font-weight:bold;"></span>.</li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    {{-- GRAFICO FINANCIERA --}}
    @if ($esuei === 0)
        <div class="row" id="grafico_financiera">
            <section class="col-lg-12 connectedSortable ui-sortable">
                <div class="nav-tabs-custom" style="cursor: default;">
                    <ul class="nav nav-tabs pull-right ui-sortable-handle">
                        <li class="pull-left header"><i class="fa fa-line-chart"></i> EJECUCIÓN FINANCIERA
                            {{ date('Y') }}</li>
                    </ul>
                    <div class="tab-content">
                ...
                <div class="box-body atajos">
                    @permission('pir-proyectoinversion')
                        <div class="col-md-2" style="margin-bottom: 5px;">
                            <a class="btn btn-block btn-primary btn-lg" href="{{ URL::to('proyecto/inicio') }}"
                                target="_blank">PROYECTOS DE INVERSIÓN</a>
                        </div>
                    @endpermission
                    @permission('pir-pmi')
                        <div class="col-md-2" style="margin-bottom: 5px;">
                            <a class="btn btn-block btn-primary btn-lg" href="{{ URL::to('carterapmi/') }}"
                                target="_blank">PMI-GRL</a>
                        </div>
                    @endpermission
                    @permission('pir-consultamigable')
                        <div class="col-md-2" style="margin-bottom: 5px;">
                            <a class="btn btn-block btn-primary btn-lg" href="{{ URL::to('consultamigable') }}"
                                target="_blank">CONSULTA AMIGABLE</a>
                        </div>
                    @endpermission
                    @permission('formato12b')
                        <div class="col-md-2" style="margin-bottom: 5px;">
                            <a class="btn btn-block btn-primary btn-lg" href="{{ URL::to('formato12b') }}"
                                target="_blank">FORMATO 12-B</a>
                        </div>
                    @endpermission
                    @permission('pir-habilitador')
                        <div class="col-md-2" style="margin-bottom: 5px;">
                            <a class="btn btn-block btn-primary btn-lg" href="{{ URL::to('habilitador/inicio') }}"
                                target="_blank">HABILITADORES</a>
                        </div>
                    @endpermission
                    @permission('pi-list')
                        <div class="col-md-2" style="margin-bottom: 5px;">
                            <a class="btn btn-block btn-primary btn-lg" href="{{ URL::to('piptotalpriori') }}"
                                target="_blank">BANCO DE PROYECTOS</a>
                        </div>
                    @endpermission
                </div>
            </div>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            var fecha = new Date();
            var esuei = {!! json_encode($esuei) !!}; // pasamos la variable PHP a JS
            if (esuei == 1) {
                $("#imp_ejec").removeClass("col-lg-9");
            }

            $("#btnDescargarTabla").on("click", function() {
                const elemento = $("#tb_pry_ejecutados_table")[
                    0]; // [0] porque html2canvas necesita el nodo DOM real

                html2canvas(elemento, {
                    scrollY: -window.scrollY, // captura aunque la tabla esté más abajo
                    backgroundColor: "#ffffff" // fondo blanco
                }).then(function(canvas) {
                    // Crear link y disparar descarga
                    $("<a>")
                        .attr("download", "reporte-ejecucion.png")
                        .attr("href", canvas.toDataURL())[
                            0] // de nuevo, necesitamos el elemento DOM para usar click()
                        .click();
                });
            });
            ...
            function getFinanc() {
                ...
                $.ajax({
                    url: "{{ url('/estadistics/chart/line/financiera') }}",
                    method: "POST",
                    data: {
                        cboYear: ano
                    },
                    success: function(response) {
                        ...
                        count = 0;
                        var devengadoAcumulado = $.map(response['devengadoAcumulado'], function(value,
                            index) {
                            count++;
                            if (count == 1) {
                                return [value];
            ...
            //Grafico Ranking
            function fchart_ranking(array_avance, array_coduei, array_pim, array_dev) {
                $data = []
                    ...
                    tooltip: {
                        contents: function(d, defaultTitleFormat, defaultValueFormat, color) {
                            ...
                            text = "<table class='" + $$.CLASS.tooltip + "'>" + (title || title === 0 ?
                                "<tr><th colspan='2' style='background-color:#3c8dbc;color:black'>" +
                                title + "</th></tr>" : "");

                            text += "<tr class='" + $$.CLASS.tooltipName + "-" + d[0].index + "'>";
                            text +=
                                "<td class='name'><span style='background-color:#f39c12'></span><b>PIM</b></td>";
                            text += "<td class='value'><b>" + number_format(array_pim[i], 0).substring(
                                0, number_format(array_pim[i], 0).length - 4) + "</b></td>";
                            text += "</tr>";
                            text += "<tr class='" + $$.CLASS.tooltipName + "-" + d[0].index + "'>";
                            text +=
                                "<td class='name'><span style='background-color:#00a65a'></span><b>DEV.</b></td>";
                            text += "<td class='value'><b>" + number_format(array_dev[i], 0).substring(
                                0, number_format(array_dev[i], 0).length - 4) + "</b></td>";
                            text += "</tr>";
                            return text + "</table>";
                        }
                    }
            ...
            function getRanking(categoria, anio) {
                $array_avance = [];
                $array_coduei = [];
                $array_sector = [];
                $array_pim = [];
                ...
                $array_avance_lima = [];
                $.ajax({
                    url: "{{ url('/estadistics/chart/line/ranking') }}",
                    data: {
                        categoria: categoria,
                        anio: anio
                    },
                    ...
                    success: function(response) {
                        ...
                        if (categoria == "PLIEGO") {
                            $array_avance = $.map(response, function(value, index) {
                                return parseFloat(value['avance'])
                            });
                            $array_coduei = $.map(response, function(value, index) {
                                return value['cod']
                            });
                            $array_sector = $.map(response, function(value, index) {
                                return {
                                    [value["cod"]]: value['gore']
                                }
                            });
                            $array_pim = $.map(response, function(value, index) {
                                return value['pim']
                            });
                            $array_dev = $.map(response, function(value, index) {
                                return value['deveng']
                            });
                        } else {
                            $array_avance = $.map(response, function(value, index) {
                                return parseFloat(value['avance_regional'])
                            });
                            $array_avance_lima = $.map(response, function(value, index) {
                                return parseFloat(value['avance_lima'])
                            });
                            $array_coduei = $.map(response, function(value, index) {
                                return value['cod']
                            });
                    ...
                    complete: function(response) {
                        fchart_ranking($array_avance, $array_coduei, $array_pim, $array_dev);
                    }
                });
            }

            function graficoFinanciero() {
                chart = c3.generate({
                    bindto: "#Financechart",
                    data: {
                        columns: [],
            ...
            table_ejecucion_meta = function(m, $anio) {
                m = parseInt(m);
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $.each(response.data, function(key, value) {
                            ...
                            //DEVENGADO
                            if (parseFloat(value['dif_dev_dia']) > 0 && m == $mes_cal) {
                                html +=
                            ...
                            } else if (parseFloat(value['dif_dev_dia']) < 0 && m ==
                                $mes_cal) {
                                html +=
                        ...
                        if ($anio == $anio_actual) {
                            ...
                            $("#avance").text("( " + number_format(($t_devengado / $t_pim) * 100,
                                1) + "% )");
                            $("#avance_pia").text("( " + number_format(($t_devengado / $t_pia) *
                                100, 1) + "% )");
                        }
                        ...
                        //TOTAL DEVENGADO
                        if ($t_total_dif > 0 && m == $mes_cal) {
                            html_pie +=
                                "<td class='text-center' style='font-weight:bold; vertical-align:middle;'><span style='color:green;font-weight:bold;'>+ " +
                                number_format($t_total_dif, 0) + "</span><br>" + number_format(
                                    $t_dev_mes, 0) + "</td>";
                        } else if ($t_total_dif < 0 && m == $mes_cal) {
                            html_pie +=
                                "<td class='text-center' style='font-weight:bold; vertical-align:middle;'><span style='color:red;font-weight:bold;'>- " +
            ...
            $mes_cal = $obtener_mes($fecha.getMonth());
            // $mes_cal = 7;
            // $mes = 4;
            $("#mes_avance > option[value=" + $mes_cal + "]").attr("selected", true);
            table_ejecucion_meta($mes_cal, $fecha.getFullYear());

            mes = function() {
                $mes = $("#mes_avance :selected").val();
                table_ejecucion_meta($mes, $fecha.getFullYear());
            }
            ...
            historia = function($anio) {
                ...
                if ($anio == (new Date).getFullYear()) {
                    ...
                    // getRanking("PLIEGO",$anio);
                    $("#data").show();
                    $("#grafico_financiera").show();
                    // }else if($anio == '2022'){
                    //     $("#text_anio").html("TOTAL DE INVERSIONES");
                    //     getRanking("PLIEGO",$anio);
                    //     table_ejecucion_meta(12,$anio);
                    //     $("#data").show();
                    //     $("#grafico_financiera").hide();
                } else {
                    $("#text_anio").html("TOTAL DE INVERSIONES");
                    $("#data").hide();
                    $("#grafico_financiera").hide();
                ...
                $.ajax({
                    url: "{{ url('/proyecto/historia_anio') }}",
                    method: 'GET',
                    data: {
                        anio: $anio
                    },
                    ...
                    success: function(response) {
                        ...
                        $("#avance").text("( " + number_format(($data['dev_dia'] / $data[
                            'pim_dia']) * 100, 1) + "% )");
                        $("#avance_pia").text("( " + number_format(($data['dev_dia'] / $data[
                            'pia_dia']) * 100, 1) + "% )");
                    },
                    complete: function(response) {
            ...
            setTimeout(function() {
                if (esuei == 0) {
                    graficoFinanciero();
                    getRanking("PLIEGO", fecha.getFullYear());
                }
                getFinanc();
            }, 500);
        });
