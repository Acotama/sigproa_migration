    ...
    <div id="modal_add" class="modal container fade" tabindex="-1" id = "containerDt" data-focus-on="input:first" data-backdrop="static" data-keyboard="false">
        ...
        <form id="frmAddTaller">
            <div class="modal-header">
                ...
                <h3 class="modal-title" style="text-align: center;">Agregar Programación de Actividad</h3>
            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group col-md-6">
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" id= "txtDocente" name="txtDocente"/>
                                    </div>
                                </div>
                                <div class="form-group col-md-6">
                                    <div class="input-group">
                                      <span class="input-group-addon" id="basic-addon1">Institución Educativa</span>
                                      <input class="form-control" id= "txtIE" name="txtIE"/>
                                    </div>
                                </div>                                
    ...
    $(document).ready(function(){
        ...
        var table = $('#poitaller-table').DataTable({            
            ...
            columns: [
                ...
                {data: 'publicada', name: 'poi_taller_usuario.publicada', width: '5%'}
            ],
