            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group text-center">
                        ...
                        <input type="text" onchange="reloadTable();" value="<?php echo date('01-m-Y') ?>" class="dateSearch datepicker" placeholder="dd-mm-yyyy" id="dateB">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group text-center">
                        <label>&nbsp&nbsp&nbsp&nbsp Fecha Fin </label>
                        <input type="text" onchange="reloadTable();" value="<?php echo date('d-m-Y') ?>" class="dateSearch datepicker" placeholder="dd-mm-yyyy" id="dateE">
                    </div>
                </div>
            </div>
...
<script>
    ...
    $(document).ready(function(){
        var table = $('#poitaller-table').DataTable({
            ...
            ajax: {
                url: '{{ url("/poi/educacion/resumen/all/activ_op/filter") }}',
                type: 'POST',
                data: function(d){
                    d.inicio          = $('#dateB').val();
                    d.fin             = $('#dateE').val();
            ...
            ,
            columns: [
                {data: 'cat_presupuestal', name: 'cat_presupuestal', width: '10%', sortable: false},
                {data: 'producto', name: 'producto', width: '10%', sortable: false},
                {data: 'act_presupuestal', name: 'act_presupuestal', width: '10%', sortable: false},
                {data: 'nombre', name: 'nombre', width: '20%', sortable: false},
                {data: 'programadas', name: 'programadas', width: '5%', sortable: false},
                {data: 'completas', name: 'completas', width: '5%', sortable: false},
                {data: 'percent', name: 'percent', width: '5%', sortable: false},
            ],
