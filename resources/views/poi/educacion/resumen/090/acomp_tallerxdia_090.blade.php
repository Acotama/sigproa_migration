...
<div id= "loader" class="loader" style="display: none"></div>
        ...
        <div class="content">
            ...
            <form method="GET">
                ...
                <button type="submit" formaction="/poi/educacion/export/090/acomp_tallerxdia/pdf" class="btn btn-default"><i class="fa fa-file-pdf-o"></i></button>
                <button type="submit" formaction="/poi/educacion/export/090/acomp_tallerxdia/excel" class="btn btn-default"><i class="fa fa-file-excel-o"></i></button>
            </form>
            <br>
             <div class="row">
                ...
                <table id="poitaller-table" class="table table-hover table-stripped" cellspacing="0">
                    <thead style="background: #3c8dbc;color: white;">
                        <tr>
                            ...
                            <th style="text-align: center;vertical-align: middle">Acompañante</th>
...
<script>
    ...
    $(document).ready(function(){
        ...
        var table = $('#poitaller-table').DataTable({
            ...
            ajax: {
                url: '{{ url("/poi/educacion/resumen/090/acomp_tallerxdia/filter") }}',
                type: 'POST',
                data: function(d){
                    d.fecha          = $('#dateB').val();
