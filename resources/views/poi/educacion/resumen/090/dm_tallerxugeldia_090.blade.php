...
<div id= "loader" class="loader" style="display: none"></div>
        ...
        ?>
            ...
            <div class="row">
                ...
                <select id="ddlNivel" onchange="reloadTable()">
                    <option value="0">-- TODOS --</option>
                    <option value="0008 - ASESORAMIENTO Y APOYO">0008 - ASESORAMIENTO Y APOYO</option>
                    <option value="0104 - EDUCACION PRIMARIA">0104 - EDUCACION PRIMARIA</option>
                    <option value="0103 - EDUCACION INICIAL">0103 - EDUCACION INICIAL</option>
                    <option value="0105 - EDUCACION SECUNDARIA">0105 - EDUCACION SECUNDARIA</option>
                </select>
            </div>
            <br>
...
<script>
    ...
    $(document).ready(function(){
        ...
        var table = $('#poitaller-table').DataTable({
            ...
            ajax: {
                url: '{{ url("/poi/educacion/resumen/090/dm_tallerxugeldia/filter") }}',
                type: 'POST',
                data: function(d){
                    d.inicio          = $('#dateB').val();
                    d.fin             = $('#dateE').val();
                    d.ugel            = $('#cboUgel :selected').val();
                    d.nivel           = $('#ddlNivel :selected').val();
                }
            },
            language:
            {
            ...
            ,
            columns: [
                {data: 'ejecutora', name: 'ejecutora', width: '15%', sortable:false},
