        ...
        <div class="content">
            ...
            <div class="row">
                ...
                <select class="form-control" id="ddlAct_op" onchange="reloadTable()">
                    ...
                    <option value="MONITOREO A LOS CENTROS DE EDUCACIÓN BÁSICA ESPECIAL - 0107 - EDUCACION BASICA ESPECIAL">MONITOREO A LOS CENTROS DE EDUCACIÓN BÁSICA ESPECIAL - 0107 - EDUCACION BASICA ESPECIAL</option>
                    <option value="CAMPAÑAS DE SENSIBILIZACIÓN - 0107 - EDUCACION BASICA ESPECIAL">CAMPAÑAS DE SENSIBILIZACIÓN - 0107 - EDUCACION BASICA ESPECIAL</option>
                    <option value="ADQUISICIÓN Y DISTRIBUCIÓN DE MATERIAL FUNGIBLE PARA EL ESTUDIANTE DEL CEBE - 0107 - EDUCACION BASICA ESPECIAL">ADQUISICIÓN Y DISTRIBUCIÓN DE MATERIAL FUNGIBLE PARA EL ESTUDIANTE DEL CEBE - 0107 - EDUCACION BASICA ESPECIAL</option>
                    <option value="TALLER PARA FAMILIAS IE INCLUSIVAS, CEBES y PRITES - 0107 - EDUCACION BASICA ESPECIAL">TALLER PARA FAMILIAS IE INCLUSIVAS, CEBES y PRITES - 0107 - EDUCACION BASICA ESPECIAL</option>                    
                    <option value="MONITOREO A LOS CEBES Y PRITES - 0107 - EDUCACION BASICA ESPECIAL">MONITOREO A LOS CEBES Y PRITES - 0107 - EDUCACION BASICA ESPECIAL</option>
                    <option value="TALLER DE ASISTENCIA A FAMILIAS - 0107 - EDUCACION BASICA ESPECIAL">TALLER DE ASISTENCIA A FAMILIAS - 0107 - EDUCACION BASICA ESPECIAL</option>
                    <option value="ASISTENCIA A FAMILIAS DE ESTUDIANTES DE CENTROS DE EDUCACION BASICA ESPECIAL PARA PARTICIPACION EN PROCESO EDUCATIVO - 0107 - EDUCACION BASICA ESPECIAL">ASISTENCIA A FAMILIAS DE ESTUDIANTES DE CENTROS DE EDUCACION BASICA ESPECIAL PARA PARTICIPACION EN PROCESO EDUCATIVO - 0107 - EDUCACION BASICA ESPECIAL</option>
                </select>
            </div>
            <br>
...
<script>
    ...
    $(document).ready(function(){
        ...
        var table = $('#poitaller-table').DataTable({
            ...
            ajax: {
                url: '{{ url("/poi/educacion/resumen/106/det_avan_persona/filter") }}',
                type: 'POST',
                data: function(d){
                    d.inicio          = $('#dateB').val();
                    d.fin             = $('#dateE').val();
