            ...
            <div class="modal-body">
                ...
                <div>
                    <ul class="nav nav-pills" role="tablist" style="color:white;">
                        ...
                        <!--li role="presentation"><a href="#financiero" aria-controls="financiero" role="tab" data-toggle="tab">Datos Financieros PIP</a></li-->
...
<!--                        <div role="tabpanel" class="tab-pane" id="financiero">
                            <br>
                            <div class="row">
                                <div class="col-md-3">{{ Form::label('m_pim', 'PIM:') }}</div>
                                <div class="col-md-3">{{ Form::text('m_pim', null, array('class' => 'form-control')) }}</div>

                                <div class="col-md-3">{{ Form::label('m_pim', 'PIM Acumulado:') }}</div>
                                <div class="col-md-3">{{ Form::text('m_pim_acu', null, array('class' => 'form-control')) }}</div>
                            </div>
                            <div class="row">
                                <div class="col-md-3">{{ Form::label('m_deveng', 'Devengado:') }}</div>
                                <div class="col-md-3">{{ Form::text('m_deveng', null, array('class' => 'form-control')) }}</div>

                                <div class="col-md-3">{{ Form::label('m_deveng_a', 'Deveng. Acum.:') }}</div>
                                <div class="col-md-3">{{ Form::text('m_deveng_a', null, array('class' => 'form-control')) }}</div>
                            </div>
                            <div class="row">
                                <div class="col-md-3">{{ Form::label('a_financ', 'Avance Financiero:') }}</div>
                                <div class="col-md-3">{{ Form::text('a_financ', null, array('class' => 'form-control')) }}</div>

                                <div class="col-md-3">{{ Form::label('f_deveng_a', 'Fecha Actualizaicion:') }}</div>
                                <div class="col-md-3">{{ Form::text('f_deveng_a', null, array('class' => 'form-control datepicker')) }}</div>
                            </div>
                        </div>-->
                        <div role="tabpanel" class="tab-pane" id="tiempo">
                            <br>
                            <div class="row">
                                <div class="col-md-3">{{ Form::label('tdr_pdf', 'Pdf TDR:') }}</div>
                                <div class="col-md-9">{{ Form::text('tdr_pdf', null, array('class' => 'form-control')) }}</div>
                            </div>
                            <div class="row">
                                <div class="col-md-3">{{ Form::label('f_tdr', 'Fecha TDR:') }}</div>
                                <div class="col-md-3">{{ Form::text('f_tdr', null, array('class' => 'form-control datepicker')) }}</div>

                                <div class="col-md-3">{{ Form::label('a_tdr', 'Avance TDR:') }}</div>
                                <div class="col-md-3">{{ Form::text('a_tdr', null, array('class' => 'form-control')) }}</div>
                            </div>
                            <div class="row">
                                <div class="col-md-3">{{ Form::label('perfil_pdf', 'Pdf Perfil:') }}</div>
                                <div class="col-md-9">{{ Form::text('perfil_pdf', null, array('class' => 'form-control')) }}</div>
                            </div>
                            <div class="row">
                                <div class="col-md-3">{{ Form::label('f_perfil', 'Fecha Perfil:') }}</div>
                                <div class="col-md-3">{{ Form::text('f_perfil', null, array('class' => 'form-control datepicker')) }}</div>

                                <div class="col-md-3">{{ Form::label('a_perfil', 'Avance Perfil:') }}</div>
                                <div class="col-md-3">{{ Form::text('a_perfil', null, array('class' => 'form-control')) }}</div>
                            </div>
                            <div class="row">
                                <div class="col-md-3">{{ Form::label('exptec_pdf', 'Pdf Exped. Tecnico:') }}</div>
                                <div class="col-md-9">{{ Form::text('exptec_pdf', null, array('class' => 'form-control')) }}</div>
                            </div>
                            <div class="row">
                                <div class="col-md-3">{{ Form::label('f_exptec', 'Fecha Exped. Tecnico:') }}</div>
                                <div class="col-md-3">{{ Form::text('f_exptec', null, array('class' => 'form-control datepicker')) }}</div>

                                <div class="col-md-3">{{ Form::label('a_exptec', 'Avance Exped. Tecnico:') }}</div>
                                <div class="col-md-3">{{ Form::text('a_exptec', null, array('class' => 'form-control')) }}</div>
                            </div>
                            <div class="row">
                                <div class="col-md-3">{{ Form::label('ejec_pdf', 'Pdf Ejecucion:') }}</div>
                                <div class="col-md-9">{{ Form::text('ejec_pdf', null, array('class' => 'form-control')) }}</div>
                            </div>
                            <div class="row">
                                <div class="col-md-3">{{ Form::label('f_ejec', 'Fecha Ejecucion:') }}</div>
                                <div class="col-md-3">{{ Form::text('f_ejec', null, array('class' => 'form-control datepicker')) }}</div>

                                <div class="col-md-3">{{ Form::label('a_ejec', 'Avance Ejecucion:') }}</div>
                                <div class="col-md-3">{{ Form::text('a_ejec', null, array('class' => 'form-control')) }}</div>
                            </div>
                             <div class="row">
                                <div class="col-md-3">{{ Form::label('liquid_pdf', 'Pdf Liquidacion:') }}</div>
                                <div class="col-md-9">{{ Form::text('liquid_pdf', null, array('class' => 'form-control')) }}</div>
                            </div>
                            <div class="row">
                                <div class="col-md-3">{{ Form::label('f_liquid', 'Fecha Liquidacion:') }}</div>
                                <div class="col-md-3">{{ Form::text('f_liquid', null, array('class' => 'form-control datepicker')) }}</div>

                                <div class="col-md-3">{{ Form::label('a_liquid', 'Avance Liquidacion:') }}</div>
                                <div class="col-md-3">{{ Form::text('a_liquid', null, array('class' => 'form-control')) }}</div>
                            </div>
                             <div class="row">
                                <div class="col-md-3">{{ Form::label('transf_pdf', 'Pdf Transferencia:') }}</div>
                                <div class="col-md-9">{{ Form::text('transf_pdf', null, array('class' => 'form-control')) }}</div>
                            </div>
                            <div class="row">
                                <div class="col-md-3">{{ Form::label('f_transf', 'Fecha Transferencia:') }}</div>
                                <div class="col-md-3">{{ Form::text('f_transf', null, array('class' => 'form-control datepicker')) }}</div>

                                <div class="col-md-3">{{ Form::label('a_transf', 'Avance Transferencia:') }}</div>
                                <div class="col-md-3">{{ Form::text('a_transf', null, array('class' => 'form-control')) }}</div>
                            </div>
                            <br>
                            <br>
                            <div class="modal-footer">
