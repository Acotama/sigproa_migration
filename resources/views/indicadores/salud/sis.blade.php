        ...
        <table class="table table-bordered " id="table_indi" width="100%" cellspacing="0" class="form-control">
          <thead>
            <tr>
              ...
              <th style="text-align:center">Con Suplemento</th>
              <th style="text-align:center">% Suplemento</th>
              <th style="text-align:center">Con Atencion</th>
              <th style="text-align:center">% Atencion</th>
              <th style="text-align:center">Con Neumococo</th>
              <th style="text-align:center">% Neumococo</th>
              <th style="text-align:center">Con Rotavirus</th>
              <th style="text-align:center">% Rotavirus</th>
              <th style="text-align:center">Con Rotavirus y Neumococo</th>
              <th style="text-align:center">% Rotavirus y Neumococo</th>
              <th style="text-align:center">Con FED</th>
    ...
    $(function(){
      ...
      grafico=function($data){
        ...
        $.each($data,function(key,value){
          ...
          if (round(value['porcentaje'],1)>=0 && round(value['porcentaje'],1)<=25) {
            $valor.push({"color":'#00a65a',"y":round(value['porcentaje'],1)});
          }
          else if (round(value['porcentaje'],1)>=26 && round(value['porcentaje'],1)<=50) {
            $valor.push({"color":'#f39c12',"y":round(value['porcentaje'],1)});
          }
          else {
            $valor.push({"color":'#dd4b39',"y":round(value['porcentaje'],1)});
          }
          ...
          for (var j = 0; j < $years.length; j++) {
              $.each($data,function(key,value){
                  if (value['years'] == $years[j]  && value['nombre'] == $nombre[e]) {
                    $valor=round(value['porcentaje'],1);
                    $nomb=value['nombre'];
                    $data_val.push($valor);
      ...
      cargardistrito=function () {
          $.ajax({
              ...
              method: 'POST',
              data: {provincial :$("#provincial :selected").val(),years :$("#years :selected").val(),opc :'sis'},
              tryCount : 0,
              retryLimit : 3,
      ...
      data=function(){
        $.ajax({
            url: '/indicadores/salud/sis_data',
            method: 'POST',
            ...
            success: function(response){
              ...
              $.each(response,function(key,value){
                    ...
                    html += "<td style='text-align:center'>"+ round(value['ninos_dni'],1)+"</td>";
                    html += "<td style='text-align:center'>"+ round(value['por_ninos_dni'],1)+"</td>";
                    html += "<td style='text-align:center'>"+ round(value['ninos_supl'],1)+"</td>";
                    html += "<td style='text-align:center'>"+ round(value['por_ninos_supl'],1)+"</td>";
                    html += "<td style='text-align:center'>"+ round(value['ninos_atencion'],1)+"</td>";
                    html += "<td style='text-align:center'>"+ round(value['por_ninos_atencion'],1)+"</td>";
                    html += "<td style='text-align:center'>"+ round(value['ninos_vac_neumococo'],1)+"</td>";
                    html += "<td style='text-align:center'>"+ round(value['por_ninos_vac_neumococo'],1)+"</td>";
                    html += "<td style='text-align:center'>"+ round(value['ninos_vac_rotavirus'],1)+"</td>";
                    html += "<td style='text-align:center'>"+ round(value['por_ninos_vac_rotavirus'],1)+"</td>";
                    html += "<td style='text-align:center'>"+ round(value['ninos_vac_rotneu'],1)+"</td>";
                    html += "<td style='text-align:center'>"+ round(value['por_ninos_vac_rotneu'],1)+"</td>";
                    html += "<td style='text-align:center'>"+ round(value['ninos_fed'],1)+"</td>";
                    html += "<td style='text-align:center'>"+ round(value['por_ninos_fed'],1)+"</td>";
                    html += "<td style='text-align:center'>"+ value['years'] +"</td>";
                    if (round(value['ninos_dni'],1)>=0 && round(value['ninos_dni'],1)<=25) {
                      html += "<td style='width:10px;text-align:center'><span class='badge bg-green text-green'>0</span></td>";
                    }
                    else if (round(value['ninos_dni'],1)>=26 && round(value['ninos_dni'],1)<=51) {
        ...
        $.ajax({
            url: '/indicadores/salud/desnutricion_grafica',
            method: 'POST',
