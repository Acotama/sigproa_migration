        ...
        <table class="table table-bordered " id="table_indi" width="100%" cellspacing="0" class="form-control">
          <thead>
            <tr>
              ...
              <th style="text-align:center">N° Evaluados</th>
              <th style="text-align:center">N° Casos Total</th>
              <th style="text-align:center">% Total</th>
              <th style="text-align:center">N° Casos Leve</th>
              <th style="text-align:center">% Leve</th>
              <th style="text-align:center">N° Casos Moderado</th>
              <th style="text-align:center">% Moderado</th>
              <th style="text-align:center">N° Casos Severa</th>
              <th style="text-align:center">% Severa</th>
    ...
    $(function(){
      ...
      grafico=function($data){
        ...
        $.each($data,function(key,value){
          ...
          if (round(value['porc_total'],1)>=0 && round(value['porc_total'],1)<=25) {
            $valor.push({"color":'#00a65a',"y":round(value['porc_total'],1)});
          }
          else if (round(value['porc_total'],1)>=26 && round(value['porc_total'],1)<=50) {
            $valor.push({"color":'#f39c12',"y":round(value['porc_total'],1)});
          }
          else {
            $valor.push({"color":'#dd4b39',"y":round(value['porc_total'],1)});
          }
          ...
          for (var j = 0; j < $years.length; j++) {
              $.each($data,function(key,value){
                  if (value['years'] == $years[j]  && value['nombre'] == $nombre[e]) {
                    $valor=round(value['porc_total'],1);
                    $nomb=value['nombre'];
                    $data_val.push($valor);
      ...
      cargardistrito=function () {
          $.ajax({
              ...
              method: 'POST',
              data: {provincial :$("#provincial :selected").val(),years :$("#years :selected").val(),opc :'anemia'},
              tryCount : 0,
              retryLimit : 3,
      ...
      data=function(){
        $.ajax({
            url: '/indicadores/salud/anemia_data',
            method: 'POST',
            ...
            success: function(response){
              ...
              $.each(response,function(key,value){
                    ...
                    html += "<td style='text-align:center'>"+ round(value['n_evaluados'],1)+"</td>";
                    html += "<td style='text-align:center'>"+ round(value['n_casos_total'],1)+"</td>";
                    html += "<td style='text-align:center'>"+ round(value['porc_total'],1)+"</td>";
                    html += "<td style='text-align:center'>"+ round(value['n_casos_leve'],1)+"</td>";
                    html += "<td style='text-align:center'>"+ round(value['porc_leve'],1)+"</td>";
                    html += "<td style='text-align:center'>"+ round(value['n_casos_moderada'],1)+"</td>";
                    html += "<td style='text-align:center'>"+ round(value['porc_moderada'],1)+"</td>";
                    html += "<td style='text-align:center'>"+ round(value['n_casos_severa'],1)+"</td>";
                    html += "<td style='text-align:center'>"+ round(value['porc_severa'],1)+"</td>";
                    ...
                    else if (round(value['porc_total'],1)>=26 && round(value['porc_total'],1)<=51) {
        ...
        $.ajax({
            url: '/indicadores/salud/anemia_grafica',
            method: 'POST',
