        ...
        <table class="table table-bordered " id="table_indi" width="100%" cellspacing="0" class="form-control">
          <thead>
            <tr>
              ...
              <th style="text-align:center">ESSALUD</th>
              <th style="text-align:center">FFAAPNP</th>
              <th style="text-align:center">Seguro Privado</th>
              <th style="text-align:center">SIS</th>
              <th style="text-align:center">Otros</th>
              <th style="text-align:center">No tiene</th>
    ...
    $(function(){
      ...
      grafico=function($data){
        ...
        $.each($data,function(key,value){
          ...
          if (round(value['total'],1)>=0 && round(value['total'],1)<=25) {
            $valor.push({"color":'#00a65a',"y":round(value['total'],1)});
          }
          else if (round(value['total'],1)>=26 && round(value['total'],1)<=50) {
            $valor.push({"color":'#f39c12',"y":round(value['total'],1)});
          }
          else {
            $valor.push({"color":'#dd4b39',"y":round(value['total'],1)});
          }
      ...
      data=function(){
        $.ajax({
            url: '/indicadores/salud/seguro_data',
            method: 'POST',
            ...
            success: function(response){
              ...
              $.each(response,function(key,value){
                    ...
                    html += "<td style='text-align:center'>"+ round(value['total'],1)+"</td>";
                    html += "<td style='text-align:center'>"+ value['essalud'] +"</td>";
                    html += "<td style='text-align:center'>"+ round(value['ffaapnp'],1)+"</td>";
                    html += "<td style='text-align:center'>"+ value['seg_privado'] +"</td>";
                    html += "<td style='text-align:center'>"+ round(value['sis'],1)+"</td>";
                    html += "<td style='text-align:center'>"+ value['otro'] +"</td>";
                    html += "<td style='text-align:center'>"+ round(value['no_tiene'],1)+"</td>";
                    ...
                    else if (round(value['total'],1)>=26 && round(value['total'],1)<=51) {
        ...
        $.ajax({
            url: '/indicadores/salud/seguro_grafica',
            method: 'POST',
