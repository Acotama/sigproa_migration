    ...
    $(function(){
      ...
      grafico=function($data){
        ...
        $.each($data,function(key,value){
          ...
          if (round(value['valor'],1)>=0 && round(value['valor'],1)<=25) {
            $valor.push({"color":'#00a65a',"y":round(value['valor'],1)});
          }
          else if (round(value['valor'],1)>=26 && round(value['valor'],1)<=50) {
            $valor.push({"color":'#f39c12',"y":round(value['valor'],1)});
          }
          else {
            $valor.push({"color":'#dd4b39',"y":round(value['valor'],1)});
          }

        });

        if ($("#tipo :selected").val()=='ANEMIA') {
          $titulo='PORCENTAJE DE PREVALENCIA DE ANEMIA EN NIÑOS COMPRENDIDOS ENTRE 6 MESES A 36 MESES DE EDAD' + ' DEL AÑO ' +  $("#years :selected").val() + ' A NIVEL ' + $("#regional").val();
          }
        else {
          $titulo='PORCENTAJE DE PREVALENCIA DE DESNUTRICIÓN CRÓNICA EN NIÑOS MENORES DE 5 AÑOS DE EDAD' + ' DEL AÑO ' +  $("#years :selected").val() + ' A NIVEL ' + $("#regional").val();
        }
      ...
      data_grafico=function($data){
        ...
        if ($("#tipo :selected").val()=='ANEMIA') {
          $titulo_his='PORCENTAJE HISTORICO DE PREVALENCIA DE ANEMIA EN NIÑOS COMPRENDIDOS ENTRE 6 MESES A 36 MESES DE EDAD' + ' A NIVEL ' + $("#regional").val();
          }
        else {
          $titulo_his='PORCENTAJE HISTORICO DE PREVALENCIA DE DESNUTRICIÓN CRÓNICA EN NIÑOS MENORES DE 5 AÑOS DE EDAD' + ' A NIVEL ' + $("#regional").val();
        }
      ...
      cargardistrito=function () {
          $.ajax({
              ...
              method: 'POST',
              data: {provincial :$("#provincial :selected").val(),years :$("#years :selected").val()},
              tryCount : 0,
              retryLimit : 3,
      ...
      data=function(){
        $.ajax({
            url: '/indicadores/salud/data',
            method: 'POST',
            data: {regional :$("#regional :selected").val(),provincial :$("#provincial :selected").val(),distrital :$("#distrital :selected").val(),tipo :$("#tipo :selected").val(),years :$("#years :selected").val()},
            tryCount : 0,
            retryLimit : 3,
            success: function(response){
              grafico(response);
              ...
              $.each(response,function(key,value){
                    ...
                    html += "<td style='text-align:center'>"+ round(value['valor'],1)+"</td>";
                    ...
                    else if (round(value['valor'],1)>=26 && round(value['valor'],1)<=51) {
        ...
        $.ajax({
            url: '/indicadores/salud/data_grafica',
            method: 'POST',
            data: {regional :$("#regional :selected").val(),provincial :$("#provincial :selected").val(),distrital :$("#distrital :selected").val(),tipo :$("#tipo :selected").val()},
            tryCount : 0,
            retryLimit : 3,
            success: function(response){
