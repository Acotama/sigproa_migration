  ...
  <div class="row">
    <div class="col-md-4">
      <div class="form-group">
          ...
          {{ Form::select('tipo',$tipo, null, array('class' => 'form-control', 'id'=>'tipo', 'onchange' => 'cargaryears(); data()')) }}
      </div>
    </div>
    <div class="col-md-4">
      <div class="form-group">
          {{ Form::label('edad', 'Edad:') }}
          {{ Form::select('edad',$edad, null, array('class' => 'form-control', 'id'=>'edad', 'onchange' => 'cargaryears(); data();')) }}
      </div>
    </div>
    <div class="col-md-4">
      <div class="form-group">
          {{ Form::label('years', 'Año:') }}
          {{ Form::select('years',array(0=>''), null, array('class' => 'form-control', 'id'=>'years', 'onchange' => 'data()')) }}
      </div>
    </div>
  </div>
  <br>
...
<script type="text/javascript">
    $(function(){
      ...
      cargaryears=function () {
          ...
          $.ajax({
              url: '/indicadores/salud/desnutricionyears',
              method: 'POST',
              data: {tipo :$("#tipo :selected").val(),edad :$("#edad :selected").val()},
              tryCount : 0,
              retryLimit : 3,
      ...
      cargardistrito=function () {
          $.ajax({
              ...
              method: 'POST',
              data: {provincial :$("#provincial :selected").val(),years :$("#years :selected").val(),opc :'desnutricion'},
              tryCount : 0,
              retryLimit : 3,
              success: function(response){
                  html = "";
      ...
      data=function(){
        $.ajax({
            url: '/indicadores/salud/desnutricion_data',
            method: 'POST',
            ...
            success: function(response){
              ...
              $.each(response,function(key,value){
                    ...
                    html += "<td style='text-align:center'>"+ round(value['n_casos'],1)+"</td>";
                    html += "<td style='text-align:center'>"+ round(value['porcentaje'],1)+"</td>";
                    ...
                    else if (round(value['porcentaje'],1)>=26 && round(value['porcentaje'],1)<=51) {
