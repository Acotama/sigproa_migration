    ...
    $(function(){
      ...
      grafico=function($data){
        ...
        $.each($data,function(key,value){
          ...
          if (round(value['promedio'],1)>=0 && round(value['promedio'],1)<=25) {
            $promedio.push({"color":'#00a65a',"y":round(value['promedio'],1)});
          }
          else if (round(value['promedio'],1)>=26 && round(value['promedio'],1)<=50) {
            $promedio.push({"color":'#f39c12',"y":round(value['promedio'],1)});
          }
          else {
            $promedio.push({"color":'#dd4b39',"y":round(value['promedio'],1)});
          }
        ...
        // console.log($years);
          ...
          $titulo='MAPA DE POBREZA ' + ' DEL AÑO ' +  $("#years :selected").val() + ' A NIVEL ' + $("#regional").val();
      ...
      data_grafico=function($data){
        ...
        for (var e = 0; e < $nombre.length; e++) {
          for (var j = 0; j < $years.length; j++) {
              $.each($data,function(key,value){
                  if (value['years'] == $years[j]  && value['nombre'] == $nombre[e]) {
                    $promedio=round(value['promedio'],1);
                    $nomb=value['nombre'];
                    $data_val.push($promedio);
          ...
          $titulo_his='MAPA HISTORICO DE POBREZA A NIVEL ' + $("#regional").val();
      ...
      cargardistrito=function () {
          $.ajax({
              url: '/indicadores/pobreza/distrito',
              method: 'POST',
      ...
      data=function(){
        $.ajax({
            url: '/indicadores/pobreza/data',
            method: 'POST',
            data: {regional :$("#regional :selected").val(),provincial :$("#provincial :selected").val(),distrital :$("#distrital :selected").val(),years :$("#years :selected").val()},
            tryCount : 0,
            retryLimit : 3,
            success: function(response){
              grafico(response);
              ...
              $.each(response,function(key,value){
                    ...
                    html += "<td style='text-align:center'>"+ round(value['inferior'],1)+"</td>";
                    html += "<td style='text-align:center'>"+ round(value['superior'],1)+"</td>";
                    html += "<td style='text-align:center'>"+ round(value['promedio'],1)+"</td>";
                    ...
                    else if (round(value['promedio'],1)>=26 && round(value['promedio'],1)<=51) {
        ...
        $.ajax({
            url: '/indicadores/pobreza/data_grafica',
            method: 'POST',
