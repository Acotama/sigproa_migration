...
<div id="container" class="container-fluid">
    <br>
    <input type=hidden id="uid" name="uid" value="{{ $Pro->id }}"/>
    ...
    <script>
        ...
        cargarPdf = function(){
            ...
            $.get('/procompite-server-pdf/' + uid.toString(), function(data) {
                            ...
                            $('#pdf_' + k).html(function () {                                
                                ...
                                $.each(val.file, function (i, v) {                                    
                                    ...
                                    html += '<div class="row">' +
                                            ...
                                            '</div>' +
                                            '<div>' +
                                            '<a onclick="procompitedeletePdf(this)" value = "'+v+'"><i value = "'+v+'" class="fa fa-times-circle fa-lg text-danger" aria-hidden="true"></i></a>' +
                                            '</div>' +
                                            '</div>';
                                    html += '</div>';
                                    c--;
        ...
        procompitedeletePdf = function(val){
