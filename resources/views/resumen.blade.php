...
<head>
    ...
    <!-- FancyBox -->
    <link rel="stylesheet" href="{{ asset('plugins/fancybox/source/jquery.fancybox.min.css') }}" type="text/css"
        media="screen" />
    <!-- jqGRID >
    ...
    <!-- CHART JS >
        <script type="text/javascript" language="javascript" src="{{ asset('plugins/chartjs/chart.min.js') }}">
            < /script--> <!-- -- > <
            script >
                $.ajaxSetup({
                    headers: {
    ...
    <div class="container-fluid" style="padding-top: 5px;">
        ...
        <div id="print">
            <div class="well text-center" style="background-color: #337ab7">
                <span
                    style="font-weight: bold;font-size: 22px;font-family: 'Source Sans Pro', 'Helvetica Neue', Helvetica, Arial, sans-serif;color: white">GOBIERNO
            ...
            <div class="row">
                <div style="text-align: center">
                    <div class="btn-group" data-toggle="btn-toggle">
                        ...
                        <a href="#" id="historia_2023" onclick="historia('2023')" style="font-weight: bold"
                            class="his_anio btn btn-primary btn-sm  active">2023</a>
                    </div>
                </div>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        <div class="info-box">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text" id="text_anio" style="font-weight: bold;">INVERSIÓN CON
                                    PIM</span>
                        ...
                        <div class="info-box">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number" style="font-size: 1.73em;text-align: center"
                                    id="pia">0</span>
                                <span class="info-box-number" style="font-size: 1.3em;text-align: center"
                                    id="avance_pia">( 0.0% )</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6 col-xs-12">
                ...
                <section class="col-lg-3 connectedSortable ui-sortable">
                    <div class="nav-tabs-custom" style="cursor: default;">
                        ...
                        <ul class="nav nav-tabs pull-right ui-sortable-handle">
                            <li class="pull-left header"><i class="fa fa-line-chart"></i>RANKING {{ date('Y') }}
                            </li>
                        </ul>
                            ...
                            <li class="pull-right header">
                                <div class="row">
                                    <div class="col-md-3 no-print">
                                        <button class="btn btn-default" id="imprimir"><i
                                                class="fa fa-print"></i></button>
                                    </div>
                                    <div class="col-md-9">
                                        <select name="mes_avance" class="form-control" id="mes_avance"
                                            onchange="mes()">
                            ...
                            <div class="chart tab-pane active" style="position: relative;">
                                <div class="table  table-responsive tb_pry_ejecutados">
                                    <table class="table table-bordered" style="width:100%;margin: 0px;"
                                        ...
                                        <thead style="background-color: #88b9d6">
                                            <tr>
                                                ...
                                                <th class="text-center subtotal_dev"
                                                    style="width:130px;vertical-align:middle;" rowspan="2">DEV
                                                    ENE<label class="mesabr"></th>
                                                <th class="text-center text-uppercase seleccion"
                                                    style="width:130px;vertical-align:middle;" rowspan="2">
                                                    DEVENGADO <label class="mes"></th>
                                            ...
                                            <tr>
                                                <th class="text-center" style="width:100px;vertical-align:middle;">
                                                    CERTIFICADO {{ date('Y') }}</th>
                                                <th class="text-center" style="width:100px;vertical-align:middle;">
                                                    COMPROMISO MENSUAL {{ date('Y') }}</th>
                                                <th class="text-center" style="width:100px;vertical-align:middle;">
                                                    DEVENGADO {{ date('Y') }}</th>
                                                ...
                                                <th class="text-center" style="width:130px;vertical-align:middle;">
                                                    INDICADOR </th>
                                        ...
                                        <tfoot>
                                            <tr id="pie_tb_pry_ejecutados" style="background-color:#88b9d6">
                                            </tr>
                                        </tfoot>
                                    </table>
                                </div>
        ...
        <div class="row" style="display:none">
            ...
            <section class="col-lg-4 connectedSortable ui-sortable">
                <div class="nav-tabs-custom" style="cursor: default;">
                    <ul class="nav nav-tabs pull-right ui-sortable-handle">
                        <li class="pull-left header"><i class="fa fa-line-chart"></i>FORMATO 12-B {{ date('Y') }}
                        </li>
                    </ul>
                    <div class="tab-content">
                        <div class="chart tab-pane active" style="position: relative;">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="box box-primary"
                            style="border-left: 3px solid #3c8dbc;border-right: 3px solid #3c8dbc;">
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $.each(response.data, function(key, value) {
                        ...
                        $porcentaje_grl =
                            (($dev_mes) / $dev_mes_meta_grl) * 100;
                        $dif_real = parseFloat(
                            value['mes_actual'] == null ? 0 : value[
                                'mes_actual']) - $dev_mes;
                        html += "<tr>";
                        html +=
                        ...
                        $t_pim += parseFloat(
                            value['pim_dia']);
                        $t_certificado += parseFloat(value[
                            'certificacion_dia']);
                        $t_devengado += parseFloat(value[
                            'dev_dia']);
                        $t_compromiso_m += parseFloat(value[
                            'ate_comp_anual_dia']);
                        $t_total_dev +=
                            $dev_suma_actual;
                        $t_dev_mes += ($dev_mes);
                        $t_total_dev_real +=
                            parseFloat(value['mes_actual'] == null ?
                                0 : value['mes_actual']);
                        $t_mes_actual +=
                            $dev_mes_meta;
                        $t_mes_actual_grl +=
                            $dev_mes_meta_grl;
                        $t_mes_meta += parseFloat(
                            $dev_mes_meta);
                        $t_mes_meta_grl += parseFloat(
                            $dev_mes_meta_grl);
                        $t_total_dif += parseFloat(value[
                            'dif_dev_dia']);
                    ...
                    $("#avance").text("( " + number_format(($t_devengado / $t_pim) * 100, 1) +
                        "% )");
                    $("#avance_pia").text("( " + number_format(($t_devengado / $t_pia) * 100,
                        1) + "% )");
